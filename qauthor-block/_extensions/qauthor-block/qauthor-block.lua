...
function Pandoc(doc)
  ...
  body:extend(create_correspondence_blocks(meta.authors, mark, meta.lang) or {})
  body:extend(create_equal_contributors_block(meta.authors, mark, meta.lang) or {})
  ...
  meta.author = pandoc.MetaInlines(create_authors_inlines(meta.author, mark, meta.lang))
